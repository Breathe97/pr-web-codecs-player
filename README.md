...
```js
// 按需引入
import { uuid, random, randomName, md5, regExps, timeFormat, timeFrom, line2hump, hump2line } from 'pr-web-codecs-player'

// 或全量引入
import * as prTools from 'pr-web-codecs-player'
```
...
[github](https://github.com/breathe97/pr-web-codecs-player)
